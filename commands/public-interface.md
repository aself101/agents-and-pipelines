...
Public interface validation passed with score >= 75
...
Public interface validation failed. Review issues above.
...
| `definition_name` | `public-interface` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/public-interface.command.yaml`
