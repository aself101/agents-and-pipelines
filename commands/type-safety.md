...
Type safety validation passed with score >= 80
...
Type safety validation failed. Review issues above.
...
| `definition_name` | `type-safety` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/type-safety.command.yaml`
