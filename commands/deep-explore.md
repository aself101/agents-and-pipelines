---
name: deep-explore
description: Deep codebase exploration using grepai semantic search and call graph tracing. Produces structured exploration reports with traced relationships and architecture mapping.
---

# Deep Explore v1
Deep codebase exploration using grepai semantic search and call graph tracing. Produces structured exploration reports with traced relationships and architecture mapping.
...
**Usage:** `/agents:deep-explore <directory>`

**Examples:**
- `/agents:deep-explore "how does the authentication flow work"`
- `/agents:deep-explore "trace data flow from API request to database"`
- `/agents:deep-explore "map the validation pipeline architecture"`
- `/agents:deep-explore packages/cli/src`
...
```bash
echo "Running deep exploration: $ARGUMENTS..."
echo "======================================="
```
...
```bash
[ -e "$ARGUMENTS" ] && echo "✓ $ARGUMENTS exists" || echo "Treating as exploration question (not a file path)"
```
...
Run the Deep Explore agent on the validated target directory:

**Agent:** deep-explore-agent.md
**Model:** Sonnet
**Target:** $ARGUMENTS
...
Exploration complete — question answered with codebase evidence
...
Exploration inconclusive — see gaps and recommendations
...
| `definition_name` | `deep-explore` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/deep-explore.command.yaml`
**Agent:** `agents/deep-explore-agent.md`
