...
description: Performs Senecan failure trajectory projection on any artifact. Projects how unaddressed failure surfaces will evolve, which assumptions will be violated as conditions change, and where preparation gaps will widen. Decision PREPARED/EXPOSED.
---

# Seneca Forecaster v1
Performs Senecan failure trajectory projection on any artifact. Projects how unaddressed failure surfaces will evolve, which assumptions will be violated as conditions change, and where preparation gaps will widen. Decision PREPARED/EXPOSED.
...
**Usage:** `/agents:seneca-forecaster <directory>`

**Examples:**
- `/agents:seneca-forecaster udl/adl/v3/code-validator.agent.yaml`
- `/agents:seneca-forecaster docs/architecture.md`
- `/agents:seneca-forecaster specs/api-spec.md`
- `/agents:seneca-forecaster agents/my-agent.md`
...
```bash
echo "Running Senecan failure trajectory projection on $ARGUMENTS..."
echo "=============================================================="
```
...
Run the Seneca Forecaster agent on the validated target directory:

**Agent:** seneca-forecaster-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | No temporal grounding for projections |
| **AF-002** | Single-scenario projection |
| **AF-003** | Prescription disguised as projection |
| **AF-004** | Generic resilience language without specific failure surfaces |
...
System PREPARED — critical failure surfaces have anticipatory infrastructure
...
System EXPOSED — foreseeable failures would produce uncontrolled damage
...
| `definition_name` | `seneca-forecaster` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/seneca-forecaster.command.yaml`
**Agent:** `agents/seneca-forecaster-agent.md`
