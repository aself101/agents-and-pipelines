...
**Usage:** `/agents:nietzsche-analyst <directory>`

**Examples:**
- `/agents:nietzsche-analyst udl/adl/v3/code-validator.agent.yaml`
- `/agents:nietzsche-analyst docs/architecture.md`
- `/agents:nietzsche-analyst src/`
- `/agents:nietzsche-analyst packages/cli/`
...
```bash
echo "Running Nietzschean genealogical analysis on $ARGUMENTS..."
echo "=========================================================="
```
...
Run the Nietzsche Analyst agent on the validated target directory:

**Agent:** nietzsche-analyst-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | Nietzschean terminology used without connection to specific observations |
| **AF-002** | Power dynamics attributed without artifact evidence |
| **AF-003** | Nietzschean aphorisms or dramatic pronouncements used as analytical content |
| **AF-004** | Prescribing action instead of reporting genealogical state |
| **AF-005** | Defensive conventions treated as symptoms of decadence |
...
Artifact VITAL — system creates its own conventions, choices known and justified
...
Artifact DECADENT — conventions inherited on institutional inertia, genealogies invisible
...
| `definition_name` | `nietzsche-analyst` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/nietzsche-analyst.command.yaml`
**Agent:** `agents/nietzsche-analyst-agent.md`
