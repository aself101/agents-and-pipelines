---
name: dx-validate
description: Developer advocate gate for real user experience testing. Runs README examples, validates error quality, tests all functionality. The "would I recommend this?" check.
---

# Developer Experience Validator v1
Developer advocate gate for real user experience testing. Runs README examples, validates error quality, tests all functionality. The "would I recommend this?" check.
...
**Usage:** `/agents:dx-validate <directory>`

**Examples:**
- `/agents:dx-validate ./packages/cli`
- `/agents:dx-validate .`
- `/agents:dx-validate ./lib`
...
```bash
echo "Running developer experience validation on $ARGUMENTS..."
echo "========================================================"
```
...
Run the Developer Experience Validator agent on the validated target directory:

**Agent:** dx-validator-agent.md
**Model:** Sonnet
**Target:** $ARGUMENTS
...
DX validation passed with score >= 75
...
DX validation failed. Review issues above.
...
| `definition_name` | `dx-validate` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/dx-validate.command.yaml`
**Agent:** `agents/dx-validator-agent.md`
