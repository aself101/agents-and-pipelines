---
name: confucius-forecaster
description: Performs Confucian relational trajectory projection on any artifact. Projects naming drift, ritual decay, and relational entropy over time. Decision HIGH_CONFIDENCE/MODERATE_CONFIDENCE/LOW_CONFIDENCE.
---

# Confucius Forecaster v1
Performs Confucian relational trajectory projection on any artifact. Projects naming drift, ritual decay, and relational entropy over time. Decision HIGH_CONFIDENCE/MODERATE_CONFIDENCE/LOW_CONFIDENCE.
...
**Usage:** `/agents:confucius-forecaster <directory>`

**Examples:**
- `/agents:confucius-forecaster udl/adl/v3/code-validator.agent.yaml`
- `/agents:confucius-forecaster docs/architecture.md`
- `/agents:confucius-forecaster specs/api-spec.md`
- `/agents:confucius-forecaster src/`
...
```bash
echo "Running Confucian relational trajectory projection on $ARGUMENTS..."
echo "==================================================================="
```
...
Run the Confucius Forecaster agent on the validated target directory:

**Agent:** confucius-forecaster-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | Maintenance plans dressed as relational trajectory analysis |
| **AF-002** | Current relational assessment presented as trajectory projection |
| **AF-003** | Erosion items treated independently without cascade mapping |
...
|-------|----------|---------|
| **>=50** | ✅ PASS | Validation passed, proceed to next phase |
| **<50** | ❌ FAIL | Validation failed, fix issues before proceeding |
...
Trajectory projection complete — relational erosion patterns identified
...
Trajectory projection incomplete — insufficient relational data for forecasting
...
| `definition_name` | `confucius-forecaster` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/confucius-forecaster.command.yaml`
**Agent:** `agents/confucius-forecaster-agent.md`
