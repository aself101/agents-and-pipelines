---
name: captive-user
description: Models someone who must use the artifact with no exit option. Surfaces friction invisible to voluntary feedback — unreported abrasions, workaround ecosystems, and enshittification risk from absent exit discipline. Decision EXIT_AVAILABLE/CAPTIVE.
---

# Captive User v1
Models someone who must use the artifact with no exit option. Surfaces friction invisible to voluntary feedback — unreported abrasions, workaround ecosystems, and enshittification risk from absent exit discipline. Decision EXIT_AVAILABLE/CAPTIVE.
...
**Usage:** `/agents:captive-user <directory>`

**Examples:**
- `/agents:captive-user udl/adl/v3/code-validator.agent.yaml`
- `/agents:captive-user docs/architecture.md`
- `/agents:captive-user README.md`
- `/agents:captive-user src/`
...
```bash
echo "Running captive user analysis on $ARGUMENTS..."
echo "=============================================="
```
...
Run the Captive User agent on the validated target directory:

**Agent:** captive-user-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | Generic UX review presented as captive-user perspective analysis |
| **AF-002** | Captive contexts manufactured where none exist |
| **AF-003** | Captive friction identified without workaround ecosystem mapping |
...
Artifact EXIT_AVAILABLE — users can leave and exit signals provide adequate feedback
...
Artifact CAPTIVE — significant captive populations with invisible friction identified
...
| `definition_name` | `captive-user` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/captive-user.command.yaml`
**Agent:** `agents/captive-user-agent.md`
