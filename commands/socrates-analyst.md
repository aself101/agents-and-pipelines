...
description: Performs Socratic elenctic examination audit on any artifact. Extracts commitments, classifies contradictions by recognition state, pressure-tests definitions, and produces diagnostic observations. Decision EXAMINED/UNEXAMINED.
---

# Socrates Analyst v1
Performs Socratic elenctic examination audit on any artifact. Extracts commitments, classifies contradictions by recognition state, pressure-tests definitions, and produces diagnostic observations. Decision EXAMINED/UNEXAMINED.
...
**Usage:** `/agents:socrates-analyst <directory>`

**Examples:**
- `/agents:socrates-analyst udl/adl/v3/code-validator.agent.yaml`
- `/agents:socrates-analyst docs/architecture.md`
- `/agents:socrates-analyst specs/api-spec.md`
- `/agents:socrates-analyst src/`
...
```bash
echo "Running Socratic elenctic examination audit on $ARGUMENTS..."
echo "============================================================"
```
...
Run the Socrates Analyst agent on the validated target directory:

**Agent:** socrates-analyst-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | Implementation bugs flagged as examination gaps |
| **AF-002** | Observations without commitment grounding |
| **AF-003** | Only explicit commitments extracted |
| **AF-004** | Generic criticism in Socratic costume |
| **AF-005** | Prescriptive solutions instead of remediation paths |
...
|-------|----------|---------|
| **>=60** | ✅ PASS | Validation passed, proceed to next phase |
| **<60** | ❌ FAIL | Validation failed, fix issues before proceeding |
...
Artifact EXAMINED — elenctic examination audit complete with diagnostic observations
...
Artifact UNEXAMINED — examination debt identified exceeds threshold
...
| `definition_name` | `socrates-analyst` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/socrates-analyst.command.yaml`
**Agent:** `agents/socrates-analyst-agent.md`
