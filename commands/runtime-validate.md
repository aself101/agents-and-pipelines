...
description: Validate actual runtime behavior of HTTP APIs through execution testing. Tests GET endpoints, verifies responses match documentation, and catches functional failures.
---

# Runtime Validator v1
...
**Usage:** `/agents:runtime-validate <directory>`

**Examples:**
- `/agents:runtime-validate ./api`
- `/agents:runtime-validate ./services/api`
- `/agents:runtime-validate .`
...
```bash
echo "Running runtime validation on $ARGUMENTS..."
echo "==========================================="
```
...
Run the Runtime Validator agent on the validated target directory:

**Agent:** runtime-validator-agent.md
**Model:** Sonnet
**Target:** $ARGUMENTS
...
Runtime validation passed - API is OPERATIONAL (score >= 70)
...
Runtime validation failed - API is BROKEN. Review failures above.
...
| `definition_name` | `runtime-validate` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/runtime-validate.command.yaml`
**Agent:** `agents/runtime-validator-agent.md`
