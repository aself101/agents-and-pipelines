...
**Usage:** `/agents:sunzi-analyst <directory>`

**Examples:**
- `/agents:sunzi-analyst udl/adl/v3/code-validator.agent.yaml`
- `/agents:sunzi-analyst docs/architecture.md`
- `/agents:sunzi-analyst specs/api-spec.md`
- `/agents:sunzi-analyst src/`
...
```bash
echo "Running Sunzian terrain-force-tempo analysis on $ARGUMENTS..."
echo "============================================================="
```
...
Run the Sunzi Analyst agent on the validated target directory:

**Agent:** sunzi-analyst-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | Strategic vocabulary decorating engineering findings |
| **AF-002** | Strategic claims without environmental evidence |
| **AF-003** | Prescribing strategy instead of assessing position |
| **AF-004** | Militarized framing of non-competitive contexts |
...
Strategic assessment complete — terrain, force, and tempo evaluated
...
Strategic assessment incomplete — insufficient environmental data for positioning
...
| `definition_name` | `sunzi-analyst` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/sunzi-analyst.command.yaml`
**Agent:** `agents/sunzi-analyst-agent.md`
