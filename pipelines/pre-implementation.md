...
description: Validates proposed design and architecture BEFORE implementation begins. Runs architect review, assumption excavation, and optional docs validation in parallel. Blocks implementation if design has critical flaws.
...
> Validates proposed design and architecture BEFORE implementation begins. Runs architect review, assumption excavation, and optional docs validation in parallel. Blocks implementation if design has critical flaws.
...
- **agents:** Collect each agent result with name, score, decision, model, and tokens
...
---
*Generated from PDL v1.1.0 | Pipeline: pre-implementation*
