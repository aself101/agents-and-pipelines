...
description: Performs foundational architecture analysis on any artifact. Traces derivation chains to terminal foundations, classifies each as DEDUCIBLE/CORROBORATED/CONVENTIONAL/SMUGGLED/OPAQUE, and maps declared-vs-actual architecture divergence. Decision TRANSPARENT/OPAQUE.
---

# Descartes Analyst v1
Performs foundational architecture analysis on any artifact. Traces derivation chains to terminal foundations, classifies each as DEDUCIBLE/CORROBORATED/CONVENTIONAL/SMUGGLED/OPAQUE, and maps declared-vs-actual architecture divergence. Decision TRANSPARENT/OPAQUE.
...
**Usage:** `/agents:descartes-analyst <directory>`

**Examples:**
- `/agents:descartes-analyst udl/adl/v3/code-validator.agent.yaml`
- `/agents:descartes-analyst docs/architecture.md`
- `/agents:descartes-analyst specs/api-spec.md`
- `/agents:descartes-analyst agents/my-agent.md`
...
```bash
echo "Running Cartesian foundational architecture analysis on $ARGUMENTS..."
echo "====================================================================="
```
...
Run the Descartes Analyst agent on the validated target directory:

**Agent:** descartes-analyst-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | No derivation chain tracing performed |
| **AF-002** | Call-graph analysis substituted for derivation chain tracing |
| **AF-003** | Terminal foundations not classified with the five-category system |
| **AF-004** | Generic architecture review with Cartesian vocabulary |
...
Artifact TRANSPARENT — derivation chains traceable, foundations classified, architecture aligned
...
Artifact OPAQUE — chains truncated, classifications inflated, or declared-vs-actual divergence significant
...
| `definition_name` | `descartes-analyst` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/descartes-analyst.command.yaml`
**Agent:** `agents/descartes-analyst-agent.md`
