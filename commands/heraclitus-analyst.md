---
name: heraclitus-analyst
description: Performs Heraclitean unity-of-opposites analysis on any artifact. Identifies constitutive tensions, traces hidden flows, assesses logos coherence, and diagnoses stagnation. Decision FLOWING/STAGNANT.
---

# Heraclitus Analyst v1
...
**Usage:** `/agents:heraclitus-analyst <directory>`

**Examples:**
- `/agents:heraclitus-analyst udl/adl/v3/code-validator.agent.yaml`
- `/agents:heraclitus-analyst docs/architecture.md`
- `/agents:heraclitus-analyst specs/api-spec.md`
- `/agents:heraclitus-analyst src/`
...
```bash
echo "Running Heraclitean unity-of-opposites analysis on $ARGUMENTS..."
echo "================================================================"
```
...
Run the Heraclitus Analyst agent on the validated target directory:

**Agent:** heraclitus-analyst-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | Heraclitean terminology used without connection to specific observations |
| **AF-002** | Dynamic claims without artifact evidence |
| **AF-003** | Fire, river, or war imagery used as analytical conclusions |
| **AF-004** | Prescribing action instead of reporting dynamic state |
...
Artifact FLOWING — system maintains identity through continuous dynamic tension
...
Artifact STAGNANT — constitutive tensions suppressed, change blocked, pressure accumulating
...
| `definition_name` | `heraclitus-analyst` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/heraclitus-analyst.command.yaml`
**Agent:** `agents/heraclitus-analyst-agent.md`
