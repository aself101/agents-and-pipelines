...
description: Traces causal chains an artifact will unleash beyond design intent. Examines first-order effects, system interactions, and feedback loops. Actor-agnostic — consequences arise from any mechanism.
---

# Unintended Consequences Agent v1
Traces causal chains an artifact will unleash beyond design intent. Examines first-order effects, system interactions, and feedback loops. Actor-agnostic — consequences arise from any mechanism.
...
**Usage:** `/agents:unintended-consequences <directory>`

**Examples:**
- `/agents:unintended-consequences udl/adl/v3/code-validator.agent.yaml`
- `/agents:unintended-consequences packages/cli/src/commands/exec/agent.ts`
- `/agents:unintended-consequences docs/specs/forecaster-agent-spec.md`
- `/agents:unintended-consequences packages/uluops-core-sdk/src/ai/AIProvider.ts`
...
```bash
echo "Running unintended consequences analysis on $ARGUMENTS..."
echo "========================================================="
```
...
Run the Unintended Consequences Agent agent on the validated target directory:

**Agent:** unintended-consequences-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | No unintended consequences found in an artifact that intervenes in a system |
| **AF-002** | Consequences named without tracing the causal chain |
| **AF-003** | Only harmful consequences considered |
| **AF-004** | No propagation confidence assessment provided |
...
Artifact ANTICIPATED — consequence chains traced and accounted for within design intent
...
Artifact UNANTICIPATED — causal chains identified beyond design intent, review before deployment
...
| `definition_name` | `unintended-consequences` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/unintended-consequences.command.yaml`
**Agent:** `agents/unintended-consequences-agent.md`
