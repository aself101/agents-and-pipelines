...
description: Performs Socratic elenctic examination on any artifact. Extracts commitments, maps contradictions, pressure-tests definitions, and produces a structured inquiry agenda. Decision EXAMINED/UNEXAMINED.
---

# Socrates Explorer v1
Performs Socratic elenctic examination on any artifact. Extracts commitments, maps contradictions, pressure-tests definitions, and produces a structured inquiry agenda. Decision EXAMINED/UNEXAMINED.
...
**Usage:** `/agents:socrates-explorer <directory>`

**Examples:**
- `/agents:socrates-explorer udl/adl/v3/code-validator.agent.yaml`
- `/agents:socrates-explorer docs/architecture.md`
- `/agents:socrates-explorer specs/api-spec.md`
- `/agents:socrates-explorer src/`
...
```bash
echo "Running Socratic elenctic examination on $ARGUMENTS..."
echo "======================================================"
```
...
Run the Socrates Explorer agent on the validated target directory:

**Agent:** socrates-explorer-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
Artifact EXAMINED — structured inquiry agenda produced
...
Artifact UNEXAMINED — commitments have not survived cross-examination
...
| `definition_name` | `socrates-explorer` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/socrates-explorer.command.yaml`
**Agent:** `agents/socrates-explorer-agent.md`
