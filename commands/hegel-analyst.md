...
**Usage:** `/agents:hegel-analyst <directory>`

**Examples:**
- `/agents:hegel-analyst udl/adl/v3/code-validator.agent.yaml`
- `/agents:hegel-analyst docs/architecture.md`
- `/agents:hegel-analyst specs/api-spec.md`
- `/agents:hegel-analyst src/`
...
```bash
echo "Running Hegelian dialectical synthesis analysis on $ARGUMENTS..."
echo "================================================================"
```
...
Run the Hegel Analyst agent on the validated target directory:

**Agent:** hegel-analyst-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | Hegelian terminology used without connection to specific observations |
| **AF-002** | Surface tensions promoted to dialectical pairs without structural interdependence test |
| **AF-003** | False synthesis claimed without locating defeated truth's reassertion |
| **AF-004** | Prospective findings without Owl-of-Minerva caveats |
| **AF-005** | Prescribing action instead of reporting developmental state |
...
Artifact SYNTHESIZED — dialectical pairs resolved through genuine Aufhebung, developmental genealogy traceable
...
Artifact CONTRADICTORY — unresolved contradictions persist as stalled oppositions, false syntheses, or premature resolutions
...
| `definition_name` | `hegel-analyst` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/hegel-analyst.command.yaml`
**Agent:** `agents/hegel-analyst-agent.md`
