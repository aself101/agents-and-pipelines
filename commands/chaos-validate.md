---
name: chaos-validate
description: Validate system resilience through live fault injection and failure simulation. Tests dependency failures, network disruptions, resource exhaustion, timeout handling, and recovery behavior through actual chaos experiments.
---

# Chaos Validator v1
Validate system resilience through live fault injection and failure simulation. Tests dependency failures, network disruptions, resource exhaustion, timeout handling, and recovery behavior through actual chaos experiments.
...
**Usage:** `/agents:chaos-validate <directory>`

**Examples:**
- `/agents:chaos-validate ./api`
- `/agents:chaos-validate ./services/api`
- `/agents:chaos-validate .`
...
```bash
echo "Running chaos validation on $ARGUMENTS..."
echo "========================================="
```
...
Run the Chaos Validator agent on the validated target directory:

**Agent:** chaos-validator-agent.md
**Model:** Sonnet
**Target:** $ARGUMENTS
...
Chaos validation passed - system is RESILIENT (score >= 75)
...
Chaos validation failed - system is FRAGILE. Review resilience issues above.
...
| `definition_name` | `chaos-validate` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/chaos-validate.command.yaml`
**Agent:** `agents/chaos-validator-agent.md`
