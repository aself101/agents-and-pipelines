...
description: Identifies failure modes that emerge when people or systems optimize against an artifact's measurable criteria — metric gaming, threshold satisficing, and ambiguity exploitation. Produces a categorized inventory with likelihood and severity rankings.
---

# Perverse Outcome Detector v1
Identifies failure modes that emerge when people or systems optimize against an artifact's measurable criteria — metric gaming, threshold satisficing, and ambiguity exploitation. Produces a categorized inventory with likelihood and severity rankings.
...
**Usage:** `/agents:perverse-outcome-detector <directory>`

**Examples:**
- `/agents:perverse-outcome-detector udl/adl/v3/code-validator.agent.yaml`
- `/agents:perverse-outcome-detector agents/v3/assumption-excavator-agent.md`
- `/agents:perverse-outcome-detector docs/specs/meta-layer-agents-spec.md`
- `/agents:perverse-outcome-detector commands/workflows/ship.md`
...
```bash
echo "Running perverse outcome detection on $ARGUMENTS..."
echo "==================================================="
```
...
Run the Perverse Outcome Detector agent on the validated target directory:

**Agent:** perverse-outcome-detector-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | No perverse outcomes found in an artifact with measurable criteria |
| **AF-002** | Findings described without the specific exploiting behavior named |
| **AF-003** | Only malicious gaming scenarios considered |
| **AF-004** | No likelihood assessment provided |
...
Artifact SOUND — no exploitable perverse incentive structures detected
...
Artifact PERVERSE — metric gaming, threshold satisficing, or ambiguity exploitation risks detected
...
| `definition_name` | `perverse-outcome-detector` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/perverse-outcome-detector.command.yaml`
**Agent:** `agents/perverse-outcome-detector-agent.md`
