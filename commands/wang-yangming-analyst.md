---
name: wang-yangming-analyst
description: Performs comprehensive knowledge-action unity analysis on any artifact. Maps declared knowledge vs. enacted behavior across the entire system surface. Produces knowledge inventory, behavioral knowledge map, gap catalog organized by mechanism, and obscuration map. Decision UNIFIED/DIVIDED.
---

# Wang Yangming Analyst v1
Performs comprehensive knowledge-action unity analysis on any artifact. Maps declared knowledge vs. enacted behavior across the entire system surface. Produces knowledge inventory, behavioral knowledge map, gap catalog organized by mechanism, and obscuration map. Decision UNIFIED/DIVIDED.
...
**Usage:** `/agents:wang-yangming-analyst <directory>`

**Examples:**
- `/agents:wang-yangming-analyst udl/adl/v3/code-validator.agent.yaml`
- `/agents:wang-yangming-analyst docs/architecture.md`
- `/agents:wang-yangming-analyst specs/api-spec.md`
- `/agents:wang-yangming-analyst src/`
...
```bash
echo "Running Wang Yangming knowledge-action analysis on $ARGUMENTS..."
echo "================================================================"
```
...
Run the Wang Yangming Analyst agent on the validated target directory:

**Agent:** wang-yangming-analyst-agent.md
**Model:** Opus
**Target:** $ARGUMENTS
...
| ID | Condition |
|----|-----------|
| **AF-001** | No knowledge inventory — analysis proceeds without cataloging declared knowledge |
| **AF-002** | No behavioral evidence assessment — analysis based solely on documentation |
| **AF-003** | Findings indistinguishable from documentation audit |
| **AF-004** | Founding documents treated as infallible source of genuine knowledge |
...
Knowledge-action UNIFIED — declared knowledge is predominantly enacted across the mapped terrain
...
Knowledge-action DIVIDED — significant gaps exist between declared and enacted knowledge
...
| `definition_name` | `wang-yangming-analyst` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/wang-yangming-analyst.command.yaml`
**Agent:** `agents/wang-yangming-analyst-agent.md`
